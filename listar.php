...
//conexão com o banco de dados//=======================================
$result_users=mysqli_query($conexao, "SELECT * FROM usuarios ");
...
<body style="font-family:calibri; display: flex;flex-direction: column; justify-content: center;background-color: white;">
        ...
        <div style="display: flex;  width:97%;flex-direction: column; height:1000px; background-color:white;box-shadow: 0px 0px 5px rgba(66,66,66,.75); margin:auto;">
            ...
            <div style="display: flex; flex-direction: row; margin:5px; ">
                <div style="display: flex;flex-direction: column ;border:1px solid black;width:12.5%">
                    <div style="">
                ...
                <div style="border:1px solid black;width:85%;margin-left:20px;">
                    
                    
                    <div  style="border:1px solid black; margin-right:4px;">
                    <?php

                    while($linhas_users=mysqli_fetch_assoc($result_users)){
                        echo $linhas_users['nome']  ;?><?php
                        echo $linhas_users['sobrenome'] . "<br>"; 
                    }  
                    ?>
                    </div>
